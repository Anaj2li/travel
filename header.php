...
?>
<?php
$metaGeneratorContent = 'Nicepage 3.2.3, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    ...
    <header class="u-clearfix u-header u-header" id="sec-e618">
  <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-c30a-5',
    ...
    <?php $logo = theme_get_logo(array(
            ...
            'default_width' => '0'
        )); ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo esc_url($logo['url']); ?>" class="u-image u-logo u-image-1 custom-logo-link" src="">
